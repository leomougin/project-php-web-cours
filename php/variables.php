        ...
        <div class="col-7 bg-dark p-3 shadow">
            <div class="d-flex">
                ...
                <div class="bg-black rounded-4 p-3 flex-fill">
                    <!-- Votre code -->
                    <p> Bonjour je m'appelle Mr <span class=" text-danger fs-1 fw-bold "><?= "$nom" ?></span></p>
                    <p> Bonjour je m'appelle Mr <?= strtoupper($nom) ?></p>
                    <p> Il y a <?= strlen($nom) ?> caractère(s) dans le nom <?= $nom ?></p>
                    <p> Il y a <span class="text-success fw-bold"><?= strlen($nom) ?></span> caractère(s) dans le nom
                        <span
                                class="fst-italic"><?= strtoupper($nom) ?></span</p>
